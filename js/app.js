import { pickQuestions, buildQuestionFromWord, AUDIO_WORDS, resetRecentOptions, saveRecentQuestionWords } from './wordbank.js?v=1.40';
import { track, submitResult, fetchScoreStats } from './analytics.js?v=1.40';
...
import { recommendChannels, INTEREST_TAGS, CHANNELS } from './channels.js?v=1.40';
...
(function initUpdateModal() {
  const UPDATE_ID   = 'v1.40-2026-09-07';         // 이 업데이트의 고유 식별자
